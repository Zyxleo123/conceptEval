...
def flux11_bfl_api(prompt, output_file_path):
    data = {
        "prompt": prompt,
        "width": 1024,
        "height": 768,
...
if __name__ == "__main__":
    ...
    if choice == "o":
        ...
        flux11_bfl_api(prompt, output_file_path)
        exit(0)
    elif choice == "s":
    ...
    import os
    with open(os.path.join('/home', 'zyx_21307130052', 'conceptEval', 'data', 'low_level_prompt_enhanced2.json')) as f:
    ...
    for concept in concepts:
        ...
        for sub_concept in concept['sub_concepts']:
            ...
            for i, instance in enumerate(sub_concept['samples']):
                ...
                flux11_bfl_api(prompt, f'output/flux11pro_prompt2_1024_768/{concept_name}_{sub_concept_name}_{i+1}.png')
